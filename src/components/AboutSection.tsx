      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <div className="space-y-6 px-4 md:px-6">
            ...
            <a
              href="/Karthik_Pasupuleti_Resume.pdf"
              download
        ...
        <div
          ref={statsRef}
          className={`mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ${statsVisible ? 'fade-in-up' : 'fade-init'}`}
          style={{ transitionDelay: '200ms' }}
        >
          <div className="bg-background border border-border rounded-lg p-6 shadow-sm transition-all duration-75 transform hover:shadow-2xl hover:-translate-y-4 hover:scale-105 hover:border-primary hover:ring-2 hover:ring-primary relative z-0 animate-float cursor-pointer">
            ...
            <p className="text-muted-foreground">Interned at Efftronics Systems Pvt. Ltd. & AP Civil Supplies | GDG Vijayawada Member | IEEE Paper Author & Reviewer</p>
          </div>
          ...
          <div className="bg-background border border-border rounded-lg p-6 shadow-sm transition-all duration-75 transform hover:shadow-2xl hover:-translate-y-4 hover:scale-105 hover:border-primary hover:ring-2 hover:ring-primary relative z-0 animate-float cursor-pointer">
            ...
            <p className="text-muted-foreground">B.Tech in AI & ML, NRI Institute of Technology | Diploma in ECE, Dhanekula Institute of Engineering and Technology</p>
          </div>
          ...
          <div className="bg-background border border-border rounded-lg p-6 shadow-sm transition-all duration-75 transform hover:shadow-2xl hover:-translate-y-4 hover:scale-105 hover:border-primary hover:ring-2 hover:ring-primary relative z-0 animate-float cursor-pointer">
            ...
            <p className="text-muted-foreground">4x National Hackathon Winner | Patent & IEEE Paper Contributor | Received Merit-Based Scholarship</p>
          </div>
        </div>
      </div>
    </section>
